...
Module_Exports({
        ...
        async(sigma, citel, text) => {
            ...
            return citel.send(img,{packname:name.packname,author:'Vince'},"sticker")
...
async(sigma, citel, text) => {
    ...
    try {
        ...
        await sigma.sendMessage(citel.chat, { video: { url: media ,}, caption: `*GENERATED BY ${name.botname}*`  },)
...
if (!text) { text=citel.quoted.text;}
    ...
    let data = await pastebin.createPaste(text, "Vince");
...
let { data } = await axios.get(`https://api.telegra.ph/createPage?access_token=d3b25feccb89e508a9114afb82aa421fe2a9712b963b387cc5ad71e58722&title=Jarvis-Md+Bot&author_name=Maher_Zubair&content=[%7B"tag":"p","children":["${a.replace(/ /g,'+')}"]%7D]&return_content=true`);
...
return citel.reply(a,{packname:'Jarvis_Md',author:'ASTRO'},"sticker") 
