...
Module_Exports({
    ...
    kingclass: "downloader",
    kingpath: __filename,
    use: "https://github.com/Vince/Jarvis-Md"
  }, async (sigma, person, tax) => {
    if (!tax) {
      return await person.send("*_Provide Repo Url,_*\n Ex: " + prefix + "gitclone *https://github.com/Vince/Jarvis-Md*");
    }
...
`;
 ...
 return await Void.sendMessage(citel.chat, buttonMessaged)
    ...
    async(sigma, person, memo) => {
        ...
        let memot = "*Jarvis-Md* *ʏᴏᴜ-ᴛᴜʙᴇ sᴇᴀʀᴄʜ*\n\n *_Search Result From_* " + memo + "\n\n*✯────────────────────✯*\n\n";
        let no = 1;
...
Module_Exports({
    ...
    let search = await yts(text);
    let i = search.all[1];
    let cap = "*Jarvis-Md* *ʏᴏᴜ-ᴛᴜʙᴇ ᴘʟᴀʏᴇʀ*\n\n*TITLE* " + i.title + "\n*DURATION* " + i.timestamp + "\n*VIEWS* " + i.views + "\n*UPLOADED* " + i.ago + "\n*AUTHOR* " + i.author.name + "\n*URL* " + i.url + ("\n*REQUESTER* " + man.pushName + "\n\n\n*_Reply 1 For Video_* \n*_Reply 2 For Audio_*");
  ...
  Module_Exports({
    ...
    if (citel[_0x14ac93(449)] && citel[_0x14ac93(438)]) {
      ...
      if (lines[0][_0x14ac93(424)]("*Jarvis-Md* *ʏᴏᴜ-ᴛᴜʙᴇ ᴘʟᴀʏᴇʀ*")) {
...
// These Downloader Commands are Developed By @Vince
// Whatsapp +
