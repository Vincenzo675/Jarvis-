...
async(bot, person, text,{isCreator}) => {
    ...
    textt = `*Jarvis-Md* *_𝚁𝙴𝚀𝚄𝙴𝚂𝚃 𝙲𝙴𝙽𝚃𝙴𝚁_*`;
    teks1 = `\n\n*_𝚄𝚂𝙴𝚁_* : @${
