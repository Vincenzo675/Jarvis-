...
Module_Exports({
 ...
 if(!text) return await citel.reply(`*_Give Me Number without + sign_*\nEx: ${prefix}iswa 9234663191xx`)
        ...
        return await citel.reply(`${text}${nobio}${nowhatsapp}*GENERATED BY ${name.botname}*`)
...
return await citel.reply(`${nobio}${nowhatsapp}*GENERATED BY ${name.botname}*`);
  
})

// These Search Commands are Developed By @Vince
// Whatsapp +
